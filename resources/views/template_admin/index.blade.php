        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePagesP" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/admin/produto">Home</a>
                        <a class="collapse-item" href="/admin/produto/novo">Inserir novo produto</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePagesM" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Opções:</h6>
                        <a class="collapse-item" href="/admin/marca">Home</a>
                        <a class="collapse-item" href="/admin/marca/novo">Inserir nova marca</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePagesC" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Opções:</h6>
                        <a class="collapse-item" href="/admin/categoria">Home</a>
                        <a class="collapse-item" href="/admin/categoria/novo">Inserir categoria</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePagesCor" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Opções:</h6>
                        <a class="collapse-item" href="/admin/cor">Home</a>
                        <a class="collapse-item" href="/admin/cor/novo">Inserir cor</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <span>Compras dos usuários</span>
                </a>
            </li>
