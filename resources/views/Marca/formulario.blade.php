                ...
                <div class="mb-3">
                    <form action="{{$endpoint}}" method="post">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control" name="nome" value="{{$input_nome}}" placeholder="Nome da marca">
                        </div>
                        <div class="mb-2">
                            <label class="form-label">Nome fantasia</label>
                            <input type="text" class="form-control" name="nome_fantasia" value="{{$input_fantasia}}" placeholder="Nome Juridico da marca">
                        </div>
                        <div class="mb-2">
