                ...
                <div class="mb-3">
                    <form action="{{$endpoint}}" method="post" id="form">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control" name="nome" value="{{$input_nome}}" placeholder="Nome do produto">
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control" name="preco" value="{{$input_preco}}" placeholder="Valor">
                        </div>
                        <div class="mb-2">
                            <label class="form-label">Quantidade</label>
                            <input type="text" class="form-control" name="quantidade" value="{{$input_quantidade}}" placeholder="Quantidade ...">
                        </div>
