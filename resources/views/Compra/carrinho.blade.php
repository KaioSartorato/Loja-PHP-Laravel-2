                        ...
                        <div class="card" style="margin-top: 10px">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="card-body">
                                        <div class="mb-2">
                                            <span class="badge badge-success">{{ $produto['id_marca'] }}</span><br>
                                            <span class="badge badge-primary">{{ $produto['id_categoria'] }}</span><br>
                                            <span class="badge badge-secondary">{{ $produto['id_cor'] }}</span><br>
                                        </div>
                        ...
                        <div style="margin: 10px; width: 50px;">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email_visitante" class="form-control" aria-describedby="emailHelp" placeholder="Digite seu email...">
